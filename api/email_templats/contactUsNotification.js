exports.getContactUsNotificationHTML = function (data, logoUrl) {
  return `
    <div style="font-family: 'Montserrat', Helvetica, Arial, sans-serif; background-color: #ffffff; color: #0b192c; max-width: 600px; margin: 0 auto; padding: 20px; border: 1px solid #e2e8f0; border-radius: 16px;">
    <style>
      ...
      <div style="text-align: center; padding-bottom: 20px; border-bottom: 2px solid #1e3e62;">
      ...
      <div style="padding: 20px 0;">
        ...
        <div style="background-color: #f8fafc; border: 1px solid #e2e8f0; padding: 15px; border-radius: 8px; margin-top: 20px; font-size: 14px;">
          ...
          <p style="margin: 0; color: #475569;"><strong style="color: #1e3e62;">Email Channel:</strong> <a href="mailto:${data.email}" style="color: #ff6500; text-decoration: none;">${data.email}</a></p>
        </div>

        <h3 style="font-family: 'Montserrat Alternates', sans-serif; color: #0b192c; font-size: 15px; margin-top: 25px; margin-bottom: 10px; font-weight: 700;">
